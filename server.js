...
app.post('/cds-services/:name', function(req, res) {
	...
	var initiateBPMNoptions = {
	    url: 'http://kie.trisotech.com:8080/kie-server/services/rest/server/containers/HelloPatient_1.0.0/processes/HelloPatient.HelloPatientMini/instances',
	    method: 'POST',
	    headers: headers,
...
//	'+ cdsHookRequest.context.patientId+'
	...
	initiateBPMNRequest(initiateBPMNoptions, function (error, response, body) {
		...
		var resultUrl =   'http://kie.trisotech.com:8080/kie-server/services/rest/server/containers/HelloPatient_1.0.0/processes/instances/'+bpmnInstanceId+'/variables/instances';
		...
		request(options, function (error, response, body) {
			...
			console.log('body:', body); // Print the HTML for the Google homepage.
				...
				console.log('parsed :', results); // Print the HTML for the Google homepage.
